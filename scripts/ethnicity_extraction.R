...
dta_2001 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2001 Census/from_scrol_dvd/data/oa/KS06.csv",
  skip = 3,
...
dta_2011 <- read_csv(
  ...
  col_types = paste(rep("c", 26), collapse = "")
)
...
write_csv(dta_2011, path="output_data/ethnicity_2011.csv")
