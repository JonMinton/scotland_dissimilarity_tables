...
dta_2001_count <- dta_2001_count %>% mutate_each(funs(
  out = round((. /100)  * `ALL PEOPLE AGED 16 - 74`)
  ),
...
dta_2011 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2011 Census/unzipped/2bblk/Output Area/KS611SC.csv",
...
write_csv(dta_2011, path="output_data/ns_sec_2011.csv")
