...
dta_2001 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2001 Census/from_scrol_dvd/data/oa/KS11a.csv",
  skip = 5,
...
dta_2001_count <- dta_2001_count %>% mutate_each(funs(
  out = round((. /100)  * `All people aged 16 to 74 in employment`, 0)
),
-output_area, -`All people aged 16 to 74 in employment`)

write_csv(dta_2001_count, path="output_data/industry_2001.csv")


#2011: KS605SC:

dta_2011 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2011 Census/unzipped/2bblk/Output Area/KS605SC.csv",
...
write_csv(dta_2011, path="output_data/industry_2011.csv")
