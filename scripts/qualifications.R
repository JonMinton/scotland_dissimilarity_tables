...
dta_2001 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2001 Census/from_scrol_dvd/data/oa/uv25.csv",
  skip = 4
)
...
write_csv(dta_2001_count, path="output_data/qualifications_2001.csv")


#2011: KS501SC

dta_2011 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2011 Census/unzipped/2bblk/Output Area/KS501SC.csv"
)
...
write_csv(dta_2011, path="output_data/qualifications_2011.csv")