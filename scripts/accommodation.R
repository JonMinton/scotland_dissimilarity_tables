...
dta_2001 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2001 Census/from_scrol_dvd/data/oa/UV42.csv",
  skip = 4
)
...
write_csv(dta_2001_count, path="output_data/accommodationtype_2001.csv")


#2011: c - QS401SC:

dta_2011 <- read_csv(
  file="E:/Dropbox/Data/Census/Scotland 2011 Census/unzipped/2cblk/Output Area/QS401SC.csv"
)
...
write_csv(dta_2011, path="output_data/accommodationtype_2011.csv")
